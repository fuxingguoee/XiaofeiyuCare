package com.example.xiaofeiyu.service;
...
import com.example.xiaofeiyu.receiver.ProcessWidgetReceiver;
	...
	public void onCreate() {
		...
		mTimerTask = new TimerTask() {
			...
			public void run() {
				...
				intent.setAction("com.example.killallbgprocess");
				// 定义一个延期的广播事件
